...
class MyArraysJUnitTests {
    ...
    void testAddUpNumbersArray() {
        ...
        assertEquals(150, myArrays.addUpNumbersArray(numbers));
        int[] numbers1 = {0,0,0,0,0};
        assertEquals(0, myArrays.addUpNumbersArray(numbers1));
        int[] numbers2 = {-1,-1,0,1,1};
        assertEquals(0, myArrays.addUpNumbersArray(numbers2));
        int[] numbers3 = {1000000,1000000,1000000,1000000,1000000};
        assertEquals(5000000, myArrays.addUpNumbersArray(numbers3));
    }
